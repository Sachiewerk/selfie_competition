...
public class App {
    ...
    /**
     * Copy the current user's info from database
     * to the SharedPreferences and redirect to next activity
     * according to the result of copy
     *
     * @param activity
     * @param dest1
     * @param dest2
     */
    public static void copyUserInfoFromDatabaseToSharedPrefAndRedirect(final Activity activity,
                                                                       final Class dest1, final Class dest2) {
        ...
        if(mAuth.getCurrentUser()!=null){
            ...
            Log.v("Tag", firebaseFirestore.collection("Users").getPath());
        }
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                                                                                                                                                                ...
                                                                                                                                                                Map<String, String> profileInfo = getUserInfoInMap(user);
                                                                                                                                                                addToSharedPreferences(activity, profileInfo);
                                                                                                                                                                redirect(activity, dest1, false);
                        }else{
                            redirect(activity, dest2, false);
                        }
                    }
        ...
        auth.getCurrentUser()
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        FirebaseAuth.getInstance().sin
                    }
                });
        /*dbr.getDatabase().goOnline();
       ...
       db.goOnline();
       db.getReference().
        Log.v("Tag", String.valueOf(FirebaseAuth.getInstance().getCurrentUser()!=null));
