...
public class Main extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ImageView profileImage =  header.findViewById(R.id.profileImage);
        ...
        /*((DrawerLayout) findViewById(R.id.drawer_layout)).addDrawerListener(new DrawerLayout.DrawerListener() {
            ...
            public void onDrawerOpened(@NonNull View drawerView) {
                TextView hintProfileImage = findViewById(R.id.hintProfileImage);
                Helper.toggleVisibility(hintProfileImage);
